...
openssl x509 -req -in dev.reviewapp.com.csr -CA reviewapp-dev-ca.pem -CAkey reviewapp-dev-ca.key -CAcreateserial -out dev.reviewapp.com.crt -days 1825 -sha256 -extfile reviewapp.ext
